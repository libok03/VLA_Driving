...
아래는 V17 sample recheck에서 선별한 DRIVE·STOP·AVOID 예시다. 각 그림은 카메라 관측, LiDAR BEV, GT와 예측 경로를 함께 보여준다.

| DRIVE | STOP | AVOID |
| --- | --- | --- |
| ![DRIVE sample](assets/morai_v17/qualitative/drive_correct.jpg) | ![STOP sample](assets/morai_v17/qualitative/stop_correct.jpg) | ![AVOID sample](assets/morai_v17/qualitative/avoid_correct.jpg) |
